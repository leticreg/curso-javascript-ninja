...
*/
var myarray = [ 6, 'Leticia', null, undefined, NaN ];
...
*/
var myarray2 = [ 8, 'Regis', false, [2, 7, 9]], { a: 65 }; ];
...
var allBooks = {
    'Latim para Iniciantes':{
        quantidadePaginas: 657,
        autor: Mesquita Sales,
        editora: 'Arety'
    },
    'Inglês Simplificado':{
...
*/
console.log( "O livro Latim para Iniciantes tem ' + book( 'Latim para Iniciantes' ).quantidadePaginas + ' páginas!" );
